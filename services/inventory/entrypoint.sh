#!/usr/bin/env bash
# =============================================================================
# Inventory Service — Container Entrypoint
...
# The proxy starts asynchronously alongside the app container, so a short wait is
# required before Alembic can open a DB connection.
...
echo "[entrypoint] Running Alembic migrations for inventory service..."
