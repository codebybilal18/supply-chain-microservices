...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, ALTER, INDEX, DROP, REFERENCES ON inventory_db.* TO 'inventory_user'@'%';
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, ALTER, INDEX, DROP, REFERENCES ON order_db.* TO 'order_user'@'%';
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, ALTER, INDEX, DROP, REFERENCES ON fulfillment_db.* TO 'fulfillment_user'@'%';
